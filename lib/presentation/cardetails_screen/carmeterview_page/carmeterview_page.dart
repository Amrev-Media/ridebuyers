...
class CarMeterView_Page extends StatefulWidget {
  const  CarMeterView_Page({
  ...
  @override
  State<CarMeterView_Page> createState() => _CarMeterView_PageState();
}

class _CarMeterView_PageState extends State<CarMeterView_Page> {
  @override
      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Center(
                child: Image.asset(
                  'lib/core/assets/images/18_car_meter.jpg',
                  fit: BoxFit.contain,
                )),
          ),
        ),
