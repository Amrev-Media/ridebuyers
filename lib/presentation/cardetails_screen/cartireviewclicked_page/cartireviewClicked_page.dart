...
class CarTireViewClicked_Page extends StatefulWidget {
  const CarTireViewClicked_Page(
  ...
  @override
  State<CarTireViewClicked_Page> createState() =>
      _CarTireViewClicked_PageState();
}

class _CarTireViewClicked_PageState extends State<CarTireViewClicked_Page> {
