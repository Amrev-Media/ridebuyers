...
class CarLeftView_Page extends StatefulWidget {
  const  CarLeftView_Page({
  ...
  @override
  State<CarLeftView_Page> createState() => _CarLeftView_PageState();
}

class _CarLeftView_PageState extends State<CarLeftView_Page> {
  @override
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Center(
                child: Image.asset(
                  'lib/core/assets/images/15_car_left_view.jpg',
                  fit: BoxFit.contain,
                )),
          ),
        ),
    ...
    ):displayCameraUI(context, widget.controller, "lib/core/assets/images/svg/carleftview.svg");
  }
