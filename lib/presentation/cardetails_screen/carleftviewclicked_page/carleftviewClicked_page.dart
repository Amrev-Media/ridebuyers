...
class CarleftViewClicked_Page extends StatefulWidget {
  const CarleftViewClicked_Page({
  ...
  @override
  State<CarleftViewClicked_Page> createState() => _CarleftViewClicked_PageState();
}

class _CarleftViewClicked_PageState extends State<CarleftViewClicked_Page> {
