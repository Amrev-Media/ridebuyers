...
class CarfrontViewClicked_Page extends StatefulWidget {
  const CarfrontViewClicked_Page({
  ...
  @override
  State<CarfrontViewClicked_Page> createState() => _CarfrontViewClicked_PageState();
}

class _CarfrontViewClicked_PageState extends State<CarfrontViewClicked_Page> {
