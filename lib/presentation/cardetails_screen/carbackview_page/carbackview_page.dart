...
class CarBackView_Page extends StatefulWidget {
  const CarBackView_Page({
  ...
  @override
  State<CarBackView_Page> createState() => _CarBackView_PageState();
}

class _CarBackView_PageState extends State<CarBackView_Page> {
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Center(
                child: Image.asset(
                  'lib/core/assets/images/9_car_back_view.jpg',
                  fit: BoxFit.contain,
                )),
          ),
        ),
    ...
    ):displayCameraUI(context, widget.controller, "lib/core/assets/images/svg/carbackview.svg");
  }
