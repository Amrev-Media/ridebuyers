...
class CarbackViewClicked_Page extends StatefulWidget {
  const CarbackViewClicked_Page({
  ...
  @override
  State<CarbackViewClicked_Page> createState() => _CarbackViewClicked_PageState();
}

class _CarbackViewClicked_PageState extends State<CarbackViewClicked_Page> {
