...
class CarTireView_Page extends StatefulWidget {
  const CarTireView_Page({
    Key? key,
    required this.loadnext, required this.controller
  }) : super(key: key);
  ...
  @override
  State<CarTireView_Page> createState() => _CarTireView_PageState();
}

class _CarTireView_PageState extends State<CarTireView_Page> {
  @override
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Center(
                child: Image.asset(
                  'lib/core/assets/images/19_car_tire.jpg',
                  fit: BoxFit.contain,
                )),
          ),
        ),
    ...
    ):displayCameraUI(context, widget.controller, "lib/core/assets/images/svg/cartire.svg");
  }
