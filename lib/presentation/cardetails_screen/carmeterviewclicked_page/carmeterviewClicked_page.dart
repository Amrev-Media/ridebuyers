...
class CarMeterViewClicked_Page extends StatefulWidget {
  const CarMeterViewClicked_Page({
  ...
  @override
  State<CarMeterViewClicked_Page> createState() => _CarmeterViewClicked_PageState();
}

class _CarmeterViewClicked_PageState extends State<CarMeterViewClicked_Page> {
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    ):displayCameraUI(context, widget.controller, "lib/core/assets/images/svg/carmeter.svg");
  }
