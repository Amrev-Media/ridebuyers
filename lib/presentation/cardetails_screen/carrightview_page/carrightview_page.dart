...
class CarRightView_Page extends StatefulWidget {
  const CarRightView_Page({
  ...
  @override
  State<CarRightView_Page> createState() => _CarRightView_PageState();
}

class _CarRightView_PageState extends State<CarRightView_Page> {
  @override
      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Center(
                child: Image.asset(
                  'lib/core/assets/images/12_car_right_view.jpg',
                  fit: BoxFit.contain,
                )),
          ),
        ),
